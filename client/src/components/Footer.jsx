  ...
  <div className="w-full flex md:justify-center justify-between items-center flex-col p-4 bg-green-800">
    <div className="w-full flex sm:flex-row flex-col justify-between items-center my-4">
      ...
      <div className="flex flex-1 justify-evenly items-center flex-wrap sm:mt-0 mt-5 w-full">
        <p className="text-white text-2xl text-center mx-2 cursor-pointer">RECYCLANT: Web3 Waste Recycling & Sustainability Solution</p>
    ...
    <div className="sm:w-[90%] w-full items-center mt-10">
      <p className="text-white text-center text-base">RECYCLANT 2022. All rights reserved.</p>
    </div>
  </div>
);
